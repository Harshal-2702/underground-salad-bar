...
const steps = [
  {
    ...
    detail: "Basmati rice or a flour wrap to hold it all together.",
    color: "#1F3D2B",
  ...
  },
  {
    ...
    detail: "Carrot, beetroot, broccoli, bell pepper, lettuce — the more the merrier.",
    color: "#1F3D2B",
  ...
  },
  {
    ...
    detail: "Makhni, Spinach, Hung Curd Garlic, Pesto or Chipotle.",
    color: "#E98A15",
